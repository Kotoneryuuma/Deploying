...
def index(request):
    return render(request, "app_retake/index.html")
...
def dashbord(request):
    ...
    return render(request, "app_retake/dashboard.html", context)

def add(request):
    context = {
    	"jobs": Job.objects.all()
    }
    return render(request, "app_retake/add.html", context)
...
def edit(request,idr):
    ...
    return render(request, "app_retake/edit.html", context)
...
def show(request,idr):
    ...
    return render(request, "app_retake/show.html", context)
